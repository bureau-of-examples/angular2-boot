...
export class DocsService {
    ...
    mockDocSummaries: DocSummaryModel[] = [
        {
            id: '1',
            title: 'v1_user-manual.pdf',
            description: 'Version 1 user manual.',
            lastUpdated: new Date('2013-12-04'),
            lastUpdatedBy: 'user 1'
        },
        {
            id: '2',
            title: 'database naming convention',
            description: 'SQL Server database naming convention.',
            lastUpdated: new Date('2014-04-12'),
